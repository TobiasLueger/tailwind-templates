...
export default function Features() {
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0 top-1/2 bg-gradient-to-t from-gray-100 to-white pointer-events-none" aria-hidden="true"></div>
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-600">
              Discover powerful features to boost your productivity. You're going to love our app.
            </p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">Manage your content with ease using our headless CMS solution.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Intuitive Interface</h4>
              <p className="text-gray-600 text-center">Our user interface is designed for maximum productivity.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Built for Speed</h4>
              <p className="text-gray-600 text-center">Experience lightning-fast performance with our optimized platform.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Extensible</h4>
              <p className="text-gray-600 text-center">Extend functionality with our powerful plugin system.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Security First</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">Get help whenever you need it with our dedicated support team.</p>
            </div>
          </div>
        </div>
      </div>
